...
import Animacao from '../tools/Animacao/Animacao'
...
function Home() {
  return (
    <>
        <h1>Título</h1>
        <ul>
            <li><a href="#sub1">Link 1</a></li>
            <li><a href="#sub2">Link 2</a></li>
            <li><a href="#sub3">Link 3</a></li>
            <li><a href="#sub4">Link 4</a></li>
            <li><a href="#sub5">Link 5</a></li>
            <li><a href="#sub6">Link 6</a></li>
            <li><a href="#sub7">Link 7</a></li>
            <li><a href="#sub8">Link 8</a></li>
        </ul>
        <h2 id='sub1'>Subtítulo 1</h2>
        ...
        <h2 id='sub8'>Subtítulo 8</h2>
        <p className='paragrafo8'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis perferendis hic ab veritatis vero ducimus pariatur. Veniam beatae consequuntur rerum architecto magnam. Veniam, iure doloribus. Repudiandae rem aut mollitia aliquam.
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis perferendis hic ab veritatis vero ducimus pariatur. Veniam beatae consequuntur rerum architecto magnam. Veniam, iure doloribus. Repudiandae rem aut mollitia aliquam.
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis perferendis hic ab veritatis vero ducimus pariatur. Veniam beatae consequuntur rerum architecto magnam. Veniam, iure doloribus. Repudiandae rem aut mollitia aliquam.
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis perferendis hic ab veritatis vero ducimus pariatur. Veniam beatae consequuntur rerum architecto magnam. Veniam, iure doloribus. Repudiandae rem aut mollitia aliquam.
